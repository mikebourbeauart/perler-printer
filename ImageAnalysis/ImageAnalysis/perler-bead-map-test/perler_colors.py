...
try:
    imagefile = "C:/Users/borbs/OneDrive/04_Job Stuff/03_Work Stuff/PERLER_BEAD_MACHINE_00000/test2.bmp"#sys.argv[1]
except:
...
beads = {}
with open('S:/GitStuff/perler-printer/ImageAnalysis/ImageAnalysis/perler-bead-map-test/beads.hex.txt', 'r') as f:
